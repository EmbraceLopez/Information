        ...
        public QMUITipDialog create() {
            ...
            switch (mCurrentIconType) {
                case ICON_TYPE_LOADING:
                    LineRotateLoadingView loadingView = new LineRotateLoadingView(mContext);
                    loadingView.setColor(Color.WHITE);
                    loadingView.setSize((int) RuleUtils.convertDp2Px(mContext, 32));
            ...
            if (mTipWord != null && mTipWord.length() > 0) {
                ...
                if (mCurrentIconType != ICON_TYPE_NOTHING) {
                    tipViewLP.topMargin = (int) RuleUtils.convertDp2Px(mContext, 12);
                }
